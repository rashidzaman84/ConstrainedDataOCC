...
public class IncrementalRevBasedReplayerImpl2b<M, C, S, T, L, A extends PartialAlignment<L, T, S>, P extends IncrementalRevBasedReplayerParametersImpl<M, L, T>>
implements IncrementalReplayer<M, C, S, T, L, A, P> {
	...
	public IncrementalRevBasedReplayerImpl2b(final S initialStateInModel, final S finalStateInModel,
