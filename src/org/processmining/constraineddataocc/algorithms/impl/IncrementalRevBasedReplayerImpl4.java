...
public class IncrementalRevBasedReplayerImpl4<M, C, S, T, L, A extends PartialAlignment<L, T, S>, P extends IncrementalRevBasedReplayerParametersImpl<M, L, T>>
	...
	public IncrementalRevBasedReplayerImpl4(final S initialStateInModel, final S finalStateInModel,
	...
	//WE MODIFIED THE getStartState() METHOD SO THAT WE CAN GET RID OF THE UNDESIRABLE EFFECT OF getLookBackWindow()
