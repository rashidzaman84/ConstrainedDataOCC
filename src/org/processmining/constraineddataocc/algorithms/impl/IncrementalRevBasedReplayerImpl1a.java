...
public class IncrementalRevBasedReplayerImpl1a<M, C, S, T, L, A extends PartialAlignment<L, T, S>, P extends IncrementalRevBasedReplayerParametersImpl<M, L, T>>
	...
	//public ArrayList<Triplet<String,Boolean,Long>> eventLevelTPE = new ArrayList<>();

	public IncrementalRevBasedReplayerImpl1a(final S initialStateInModel, final S finalStateInModel,
